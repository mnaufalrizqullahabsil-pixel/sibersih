...
class _LaporanSampahPageState extends State<LaporanSampahPage>
  ...
  void _removePhotoAt(int index) {
    setState(() {
      ...
      _carouselIndex = _photos.isEmpty ? 0 : (_carouselIndex).clamp(0, _photos.length - 1);
    });
    WidgetsBinding.instance.addPostFrameCallback((_) {
  ...
  Future<void> _submitLaporan() async {
    ...
    final rejected = _photos.where((p) => p.scanResult != null && !p.scanResult!.isAccepted).toList();
    ...
    if (_beratController.text.isEmpty) {
      _showSnack('Masukkan berat / jumlah botol ⚖️');
      return;
    }
    ...
    final berat = double.tryParse(
            _beratController.text.replaceAll(RegExp(r'[^0-9.]'), '')) ??
        0.0;
    ...
    if (mounted) {
      ...
      _showResultDialog(ok, (berat * 0.1).round().clamp(50, 500));
    }
  }
          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                ...
                _sectionTitle('Foto Botol Plastik', Icons.photo_library_rounded),
          ...
          Container(
            ...
            child: const Column(
              children: [
                ...
                SizedBox(height: 2),
                Text('AI Valid', style: TextStyle(color: Colors.green, fontSize: 10, fontWeight: FontWeight.w700)),
              ],
            ),
          ),
        ],
  ...
  Widget _buildDetailSection(bool isDark) {
    return Column(
      children: [
        _buildInputField(
          label: 'Jumlah / Berat',
          hint: 'Contoh: 5 botol atau 1.5 kg',
          icon: Icons.scale_rounded,
          controller: _beratController,
        ),
        const SizedBox(height: 14),
        _buildInputField(
          label: 'Lokasi Pembuangan',
          hint: 'Contoh: Depan Gedung A, Lantai 2',
      ...
      child: Row(
        children: [
          ...
          const Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Estimasi poin', style: TextStyle(color: Colors.grey, fontSize: 12)),
              Text('~100 poin', style: TextStyle(color: Colors.green, fontWeight: FontWeight.w900, fontSize: 20)),
            ],
          ),
          const Spacer(),
          Container(
  ...
  Widget _buildSubmitButton() {
    final hasRejected = _photos.any((p) => p.scanResult != null && !p.scanResult!.isAccepted);
            ...
            child: _isSubmitting
                ...
                : const Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 8),
                      Text('Kirim Laporan', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w800)),
                    ],
                  ),
          ),
        ),
  ...
  List<Widget> _corners() {
    ...
    return [
      ...
      const Positioned(
        top: 16,
        left: 16,
        child: _Corner(size: size, thick: thick, color: color,
            top: true, left: true),
      ),
      // TR
      const Positioned(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text('Estimasi poin', style: TextStyle(color: Colors.grey, fontSize: 11)),
                        Text('+$points poin',
                            style: const TextStyle(
                                color: Color(0xFF1007BA), fontWeight: FontWeight.w900, fontSize: 22)),
                      ],
                    ),
                  ],
                ),
